package com.DemoGenericUtilities;
	...
	public class WebDriverUtilities {
		...
		{
			driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(IAutoConstants.implicitlyWaitDuration));
		}
		/**
		...
		{
			driver.manage().timeouts().scriptTimeout(Duration.ofSeconds(IAutoConstants.scriptTimeOutDuration));
		}
		/**
		...
		{
			WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(IAutoConstants.explicitWaitDuration));
		...
		/*Switch back to Parent Window using Actual url
		 * 
		 * 
		 */
		public void switchBackToMainWindow(WebDriver driver, String win)
		{
